...
public class CompletedShipsAdapter extends RecyclerView.Adapter<CompletedShipsAdapter.ViewHolder> {
    private ArrayList<TransportList> list;
    private Context context;

    public CompletedShipsAdapter(ArrayList<TransportList> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_completed_ships, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.item_completed_ships_money)
        TextView tvTransportMoney;

        @BindView(R.id.item_completed_ships_source_city)
        TextView tvSourceCity;

        @BindView(R.id.item_completed_ships_destination_city)
        TextView tvDestinationCity;

        @BindView(R.id.item_completed_ships_thing)
